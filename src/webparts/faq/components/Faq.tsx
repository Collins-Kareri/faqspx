...
const Faq: FunctionComponent<IFaqProps> = (props) => {
  ...
  return props.configured ? (
    <Stack style={{ backgroundColor: props.themeVariant ? props.themeVariant.semanticColors?.bodyBackground : "white" }}>
      {showMessage ? (
        <Stack style={{ color: props.themeVariant ? props.themeVariant.semanticColors?.bodyText : "white" }}
